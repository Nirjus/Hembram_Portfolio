...
const Footer = (props: Props) => {
  return (
        ...
        <div className='  w-full h-full p-5 lg:w-[80%] md:w-[90%] sm:w-[95%] mx-auto'>
         <div className=' grid grid-cols-1 md:grid-cols-3 lg:gap-4 md:gap-3 gap-4'>
          <div className=' w-full flex flex-col gap-3 items-center justify-start max-md:border-b-2 md:border-r-2 border-slate-700 dark:border-[#b8b8b896] lg:p-3 p-2'>
            <p className=' text-lg font-semibold text-gray-700 dark:text-gray-300'> Thanks for visiting my Portfolio,</p>
            <p className=' text-gray-600 dark:text-gray-400 font-medium'>For further importent updateds, stay <br /> connected with me.</p>
   ...
   <div className=' space-y-3 border-b-4 border-[#85858580] pb-8'>
   <li className=' text-base font-roboto text-gray-600 dark:text-gray-400'>Kalyani</li>
    <li className=' text-sm font-roboto text-gray-600 dark:text-gray-400'>Kol: 700145, North 24 prganas</li>
    <li className=' text-sm font-roboto text-gray-600 dark:text-gray-400'>West Bengal, India</li>
   </div>
          ...
          <div className=' w-full flex flex-col gap-3 items-center justify-start  lg:p-3 p-2'>
